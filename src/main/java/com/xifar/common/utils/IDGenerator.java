 ...
 */
public final class IDGenerator implements Comparable<IDGenerator>, Serializable {
	 ...
	 *             zero
	 */
	public IDGenerator(final int timestamp, final int machineIdentifier, final short processIdentifier,
			final int counter) {
		this(timestamp, machineIdentifier, processIdentifier, counter, true);
	}

	private IDGenerator(final int timestamp, final int machineIdentifier, final short processIdentifier,
	...
	public boolean equals(final Object o) {
		...
		IDGenerator objectId = (IDGenerator) o;
