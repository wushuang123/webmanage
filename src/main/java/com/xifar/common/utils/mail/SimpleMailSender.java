...
//		pro.put("mail.smtp.ssl.socketFactory", sf);
	...
	public static void main(String[] args) throws Exception {
		...
		mailInfo.setMailServerPort("25");
		mailInfo.setValidate(true);
		mailInfo.setUserName("1316452047@qq.com");
		mailInfo.setPassword("efkozckqacofjahf");// 您的邮箱密码
		mailInfo.setFromAddress("1316452047@qq.com");
		mailInfo.setToAddress("zxj100@foxmail.com");
		mailInfo.setSubject("您好");
		mailInfo.setContent("您中大奖了，赶紧领取");
		Security.addProvider(new Provider());
