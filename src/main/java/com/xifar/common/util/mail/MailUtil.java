...
public class MailUtil {
	...
	public static void main(String[] args) {
		...
		String[] array =new String[2]; list.toArray(array);
		boolean s = MailUtil.send("smtp.qq.com", 25, true, "@qq.com", "", "@qq.com", "@qq.com", array, "您好", "您中大奖了，赶紧领取<h1>非常好的</h1>", "text/html;charset=utf-8", true, true);
